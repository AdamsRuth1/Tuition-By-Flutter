        ...
        >
          ...
          >
            ...
            <h6 className="fs my-4">
              This isn't just a wallet; it's your launchpad to a smoother ‘study
              abroad’ experience. Forget the stress of accessing money in a new
              country, our Digital Wallet lets you hit the ground running, so
              you worry less about getting access to spendable money and focus
              on what truly matters: immersing yourself in the culture and
        ...
        >
          <div className="col-md-6 mb-4 mb-md-0 " style={{ textAlign: "left" }}>
            ...
            <h6 className="fs my-4">
              ...
              flexible and empathetic solution designed to help you save towards
              your educational goals in a stress-free manner.
            </h6>
            <Button className="sign-in me-4">
      ...
      <Container className="" style={{ marginTop: "240px" }}>
        ...
        >
          ...
          >
            ...
            <h6 className="fs my-4">
              We get it. Studying abroad sounds incredible, but the journey can
              feel overwhelming. Sifting through countless websites, unsure
              which are reliable and which are scams, can leave you feeling
              lost.
              <br />
              <br />
              ...
              Explore our Blog today and take the first step towards a brighter
              future with our empathetic and reliable guidance – because we
              believe in making your dreams a reality, one post at a time.
            </h6>
            <Button className="sign-in me-4">
        ...
        >
          <div className="col-md-6 mb-4 mb-md-0 " style={{ textAlign: "left" }}>
            ...
            <h6 className="fs my-4">
              ...
              covered. We offer different payment pathways specifically designed
              for you, ensuring a smooth and stress-free learning experience.
              <br /> <br />
